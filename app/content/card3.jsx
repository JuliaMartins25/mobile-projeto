        ...
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.card} showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.description}>
                    Sim! Cada tipo de cabelo (liso, ondulado, cacheado e crespo) tem características e necessidades específicas que influenciam diretamente na forma correta de cuidar.
                </Text>

                <Text style={styles.sectionTitle}>Classificação dos Tipos de Cabelo</Text>
                <Text style={styles.description}>
                    A classificação é feita por números (1 a 4) e letras (A, B, C), com base em curvatura e espessura dos fios:
                </Text>
                <Text style={styles.tableHeader}>Tipo   | Subtipos   | Características principais</Text>
                <Text style={styles.tableRow}>1 - Liso      | 1A, 1B, 1C   | Fios retos, oleosos, pouco volume e frizz.</Text>
                <Text style={styles.tableRow}>2 - Ondulado  | 2A, 2B, 2C   | Ondas soltas a intensas, mais volume, frizz.</Text>
                <Text style={styles.tableRow}>3 - Cacheado  | 3A, 3B, 3C   | Cachos definidos, frizz, precisam de hidratação.</Text>
                <Text style={styles.tableRow}>4 - Crespo    | 4A, 4B, 4C   | Cachos fechados ou zigue-zague, muito volume, secos e frágeis.</Text>
                ...
                <Text style={styles.sectionTitle}>Dica Sustentável: Produtos em Barrinhas</Text>
                <Text style={styles.description}>
